...
export function UiModal({ width = "md", className, children }) {
  return (
    ...
    >
      ...
      >
        {children}
        <button className="w-8 h-8 flex items-center justify-center text-white rounded-md bg-white/10 hover:bg-white/40 transition-colors absolute top-0 -right-10">
          <CrossIconLight />
        </button>
      </div>
    </div>
